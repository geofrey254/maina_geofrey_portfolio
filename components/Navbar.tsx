...
export default function Navbar() {
  ...
  return (
    <div className="relative">
      <nav className="navbar fixed w-full h-24 shadow-xl z-5 bg-special">
        <div className="flex justify-between items-center h-full w-full">
          {/* Left side of the navbar */}
          <div className="left-side px-4 md:px-6 2xl:px-16 flex">
            <h1 className="name text-main font-bold text-xl">MG</h1>
          </div>
          {/* Center of Navbar */}
          ...
          <div className="right-side flex">
            ...
            <div
              onClick={handleNav}
              className="sm:hidden cursor-pointer color-1 mr-4 "
            >
              <div>
                <CgMenuOreos
                  size={40}
          ...
          >
            <ul className="flex flex-col text-xl space-y-12 pt-6 pl-6">
              <li className="font-semibold">
                <Link href="#" className="cursor-default flex">
                  <FaFileContract className="mr-2" size={25} />
                  Services
