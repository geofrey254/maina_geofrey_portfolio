...
export default function Hero() {
  return (
    <div className="bg-white md:flex grid-cols-12 section-padding-100-70 place-content-center items-center">
      {/* right side */}
      <div className="right-side pl-4 md:pl-8 md:space-y-8 col-span-12 md:col-span-5">
        ...
        <div className="description">
          <p className="descr text-black text-sm md:text-lg">
            Dedicated Software Developer and Graphic Designer with a <br />
            passion for creating innovative and visually stunning solutions.
          </p>
        </div>
